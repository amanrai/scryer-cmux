        ...
        <div className="settings-shell">
          ...
          {page === 'pty' ? <div className="settings-page">
            ...
            {ptyDraft ? <div className="settings-form">
              ...
              <label><span className="field-label">PTY URL reachable by gateway</span><input className="rename-input" value={ptyDraft.publicUrl} placeholder="http://tailnet-host:43222" onChange={(event) => setPtyDraft({ ...ptyDraft, publicUrl: event.target.value })} /></label>
